...
overiding the __colne() function to copy the wanted fields and then using clone() method to copy object to another object
*/
...
class Page
{
     ...
     * - The author of the page remains the same.
